...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bg5of78.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bg5of78.containers.anotherwebservice.com/
...
```
git clone git@github.com:H-a-S-a-N-990/container-bg5of78.git
cd container-bg5of78
```
...
```
docker attach container-bg5of78
```
